...
<grid class="sm:grid sm:grid-cols-2">
	...
	<div>
		...
		<p>
			...
			Farmers Coalition's Michigan Organizer at <a href="mailto: payge@youngfarmers.org"
				>payge@youngfarmers.org</a
			>.
		</p>
	</div>
	<div>
		...
		<p>
			...
			media, or graphic design, we may have a need for your expertise. Please <a href="/Contact-Us"
				>fill out our form</a
	...
	<div>
		...
		<ul class="list-disc ml-4">
			<li>
				Host a raffle or promote a certain product with proceeds going towards the land fund. Some
				other local examples of this include the Sovengard’s fundraiser for us through their
				Cocktail for a Cause program, and the Dreamgoats gift basket collaboration.
			</li>
			<li>
				Add an option on your checkout screen to “add a tip for the West MI Farmers of Color Land
				Fund”
			</li>
			<li>
				Share
				<a href="https://www.gofundme.com/f/dtuz62-west-michigan-farmers-of-color-land-fund"
					>our fundraiser
				</a> with your customers on social media platforms
			</li>
			<li>Match any donations made by your employees to the fundraiser.</li>
		</ul>
	</div>
</grid>
